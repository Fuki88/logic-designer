...
namespace Digi_graf_modul
{
    public partial class Connection : Control
    {
        public Connection()
        {
            ...
            if (!Graf_editor.form.SetLabelVisible)
            {
        ...
        private void lblStartEnd_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
                ((Label)sender).Left = -Graf_editor.form.Left - Graf_editor.form.GetMainPanel.Left + System.Windows.Forms.Cursor.Position.X - 10 + Graf_editor.form.GetMainHScroll.Value - 90;
                ((Label)sender).Top = -Graf_editor.form.Top - Graf_editor.form.GetMainPanel.Top + System.Windows.Forms.Cursor.Position.Y - 45 + Graf_editor.form.GetMainVScroll.Value - 45;
                 Graf_editor.form.PaintMainMove();
